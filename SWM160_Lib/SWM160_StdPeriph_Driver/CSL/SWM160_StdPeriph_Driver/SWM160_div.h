#ifndef __SWM160_DIV_H__
#define __SWM160_DIV_H__
...
* 注意事项: 无
******************************************************************************************************************************************/
static __INLINE void DIV_Div(uint32_t dividend, uint32_t divisor)
{
	DIV->DIVIDEND = dividend;
	DIV->DIVISOR = divisor;
	
	DIV->CR = (1 << DIV_CR_DIVGO_Pos);
}
...
* 注意事项: 无
******************************************************************************************************************************************/
static __INLINE void DIV_Div_Result(uint32_t *quotient, uint32_t *remainder)
{
	*quotient = DIV->QUO;
