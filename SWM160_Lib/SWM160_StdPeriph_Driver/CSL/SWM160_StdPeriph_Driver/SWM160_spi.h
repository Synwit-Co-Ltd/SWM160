#ifndef __SWM160_SPI_H__
#define __SWM160_SPI_H__
...
typedef struct {
	...
	uint8_t  RXFullIEn;		//接收FIFO满  中断使能
	uint8_t  TXHFullIEn;	//发送FIFO半满中断使能
	uint8_t  TXEmptyIEn;	//发送FIFO空  中断使能
} SPI_InitStructure;
