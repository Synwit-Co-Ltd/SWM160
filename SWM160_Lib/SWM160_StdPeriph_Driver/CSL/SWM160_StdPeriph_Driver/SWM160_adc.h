#ifndef __SWM160_ADC_H__
#define	__SWM160_ADC_H__

typedef struct {
	uint8_t clk_src;		//ADC转换时钟源：ADC_CLKSRC_SYSCLK_DIV4、ADC_CLKSRC_XTAL_DIV4
...
#define ADC_CLKSRC_SYSCLK_DIV4	0	//系统时钟
#define ADC_CLKSRC_XTAL_DIV4	1	//外部晶体振荡器

#define ADC_AVG_SAMPLE1			1	
#define ADC_AVG_SAMPLE2			3	//一次启动连续采样、转换2次，并计算两次结果的平均值作为转换结果
